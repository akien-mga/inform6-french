...
! Ask:      see Answer
  ...
  Miscellany: switch (n) {
		...
		! 30: "Cela n'est pas référencé ici, soit ce n'est pas disponible, soit c'est insignifiant";
		! 30: "Vous ne pouvez voir une telle chose, à moins qu'elle soit sans grande importance.";
...
! Turn: see Pull.
  ...
  WaveHands:      "Vous agitez vos mains devant vous.";
  Wear: switch (n) {
