...
[ LanguageVerbLikesAdverb w;
    if (w == 'look' or 'go' or 'push' or 'walk' or 'regarder' or 'aller' or 'pousser' or 'marcher')
        rtrue;
    rfalse;
];
...
!             28: print "Je n'ai compris que : ";
	      28: "Merci de reformuler (éventuellement en retirant les articles). Je ne connais que : ";
              ...
              37: "Vous ne pouvez faire cela qu'à une chose animée.";
              38: "Je ne connais pas ce verbe.";
              39: "Ce n'est pas une chose à laquelle vous devrez vous référer
                   au cours du jeu.";
...
!              49: print "Pouvez-vous préciser avec quoi ? (tapez le nom seul, sans la préposition 'avec')^";
  ...
  Pray:           "Rien de pratique ne résulte de votre prière.";
  Prompt:   print "^>";
  Pronouns: switch (n) {
...
! Push: see Pull
  ...
  Quit: switch (n) {
               ...
               2: print "Etes-vous sûr de vouloir quitter ? ";
    }
  Remove: switch (n) {
  ...
  Restart: switch (n) {
               1: print "Etes-vous sûr de vouloir recommencer ? ";
               2: "Raté.";
    }
  Restore: switch (n) {
  ...
  Sing:           "Vouz chantez abominablement faux.";
...
#Ifndef NI_BUILD_COUNT;
  ...
  SwitchOn: switch (n) {
	  ...
	  Take:    switch(n)
           {   1: "D'accord."; ! ok.
               2: "Vous vous possédez vous-même.";
