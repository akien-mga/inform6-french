...
!   L'adaptation à Glulx a été réalisée avec l'aide d'Eric Forgeot. 3ème personne singulier passé
...
Constant YOURSELF__TX = "lui-même";
#Ifnot;
...
! Ask:      see Answer
  ...
  JumpOver, Tie:  "Il n'arriverait à rien comme ça.";
...
! Push: see Pull
  ...
  Search: switch (n) {
               ...
               3: print "Sur ", (the) x1, ", il vit "; 
                  ...
                  ".";
               4: "Il ne trouva rien d'intéressant.";
